...
<div id="poll_links" style="padding-top:5px; ">
	<div id="poll_buttons_<?php echo $poll->id;?>" class="poll_buttons">	
	...
	<a class="poll_result_link" href="<?php echo JRoute::_('index.php?option=com_acepolls&view=poll&id='.$slug.$itemid); ?>"><?php echo JText::_('MOD_ACEPOLLS_VIEW_DETAILS'); ?></a>
	<?php endif; ?>
    </li>
	<li>
