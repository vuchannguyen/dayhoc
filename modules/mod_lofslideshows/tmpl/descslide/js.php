<script type="text/javascript">
  ...
  var direction = '<?php echo ( isset($themeConfig['navslide-descdirection']) ?$themeConfig['navslide-descdirection']:"left");?>';
  ...
  var object = new LofSlideshow( _lofmain,
                  { 
					...
					onNavActived:function(index, currentSlider){  
						(function(){
							if( info ) {	  
								info.tween(direction,-500);
							} 
							if( $defined(currentSlider.getElement(".lof-description")) ) {
					 			currentSlider.getElement(".lof-description").set('tween', {duration: 'long',transition:Fx.Transitions.Sine.easeInOut} ).tween(direction,20);
							}
						}).delay(300);
					}
                  } );
