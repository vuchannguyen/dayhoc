...
<div id="lofslideshow<?php echo $module->id; ?>" class="descslide" style="height:<?php echo $moduleHeight;?>; width:<?php echo $moduleWidth;?>">
  ...
  <div class="lof-container <?php echo $class;?> ">
      ...
      <?php endif; ?>
    <!-- MAIN CONTENT -->
    <div class="lof-main-wapper <?php echo $css3Class;?>" style="height:<?php echo (int)$params->get('main_height',300);?>px;width:<?php echo (int)$params->get('main_width',650);?>px;">
              ...
              <div class="lof-navigator-outer">
                    ...
                    <?php foreach( $list as $row ):?>
                        <li style="border:0">
                            ...
                            <img height="<?php echo $thumbnailHeight;?>" width="<?php echo $thumbnailWidth?>" style="" src="<?php echo $row->thumbnail;?>" title="<?php echo $row->title?>" />
                             	</div>
                            </li>
                     <?php endforeach; ?> 		
                    </ul>
